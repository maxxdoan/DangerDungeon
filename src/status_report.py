...
class DiamondCollector(gym.Env):
    ...
    def __init__(self, env_config):  
        ...
        # Rllib Parameters
        self.action_space = Box(low=-1.0, high=1.0, shape=(2,), dtype=np.float32) #CHANGED FROM DISCRETE TO BOX
    ...
    def step(self, action):
        ...
        # Get Action
        move_com = 'move ' + str(move)
        jump_com = 'jump ' + str(jump)

        #Send the 3 Commands then sleep for t > .2 and freeze in place
        self.agent_host.sendCommand(move_com)
        self.agent_host.sendCommand(jump_com)
        ...
        return '''<?xml version="1.0" encoding="UTF-8" standalone="no" ?>
                <Mission xmlns="http://ProjectMalmo.microsoft.com" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
                    ...
                    <AgentSection mode="Survival">
                        ...
                        <AgentStart>
                            <Placement x="-655.5" y="5" z="-81.5" pitch="30" yaw="-180"/>
                            <Inventory>
                        ...
                        <AgentHandlers>
                            <RewardForMissionEnd rewardForDeath="-10">
                                <Reward reward="'''+str(self.last_obs[2]*50)+'''" description="found_goal"/>
                            </RewardForMissionEnd>
    ...
    def get_observation(self, world_state):
        ...
        while world_state.is_mission_running:
            ...
            if world_state.number_of_observations_since_last_state > 0:
                ...
                obs[0] = (-observations['XPos'] - self.xleft) / (self.xleft - self.xright)
                ...
                # obs[0] = (-observations['XPos'])
                # obs[1] = 0.0 # might not need this
                # obs[2] = (-observations['ZPos'])
                # obs[3] = observations['Yaw']
